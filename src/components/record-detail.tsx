...
export default function RecordDetail({
  ...
  // Manual user-authored connections (Phase 5), computed server-side and passed
  // in by both surfaces.
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-5 sm:px-6 sm:py-6">
        ...
        {/* ---- Connections (manual, user-authored — Phase 5) ----
            Above Related: your deliberate links come before AI suggestions. */}
        <RecordConnections recordId={record.id} connections={connections} />
      ...
      <div className="flex items-center justify-between border-t border-gray-200 px-6 py-4 dark:border-gray-700">
        ...
        {/* Actions — uniform 36x36 icon buttons so the row stays tidy on
            mobile (labels lived here before and wrapped/crowded the footer). */}
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            title="Delete"
            className="flex h-9 w-9 items-center justify-center rounded-md text-red-500 hover:bg-red-50 disabled:opacity-50 dark:hover:bg-red-950"
          >
            {/* Trash icon */}
            <svg
              className="h-4 w-4"
